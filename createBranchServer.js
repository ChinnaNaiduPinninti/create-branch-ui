...
app.post('/createBranch', (req, res) => {
	...
	if (regex.test(branchName)) {
		if (branchCategory == 'develop')
        {
             ...
             var script = exec(`C:/Users/vkraft/AppData/Local/Programs/Git/git-bash.exe C:/Users/vkraft/pubsubusingkafkaandwebmrepo/git-createBranch-script.sh "${branchName},${serverName},${branchType}",${branchCategory}`,
				(error, stdout, stderr) => {
					console.log(stdout);
					console.log(stderr);
					if (error !== null) {
